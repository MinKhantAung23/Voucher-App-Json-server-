...
const VoucherCard = () => {
  ...
  if (isLoading)
    return (
      <div className="my-6 flex justify-center items-center h-full">
        <l-spiral size="40" speed="0.9" color="blue"></l-spiral>
      </div>
    );
  if (error)
    return <div className="my-6 text-red-500">An error has occurred.</div>;
  return (
    <div className="flex flex-col md:flex-row gap-5">
      <div id="printArea" ref={printRef} className="w-[14.8cm] bg-white p-5">
